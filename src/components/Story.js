    ...
    <div className='w-full h-full'>
      <div>
        <figure className='h-40 w-full overflow-hidden  relative'>
          ...
          <h2 className='text-xl text-black font-semibold absolute top-1/2 -translate-y-1/2  left-1/2 -translate-x-1/2 '>About Us</h2>
        </figure>
        ...
        <figure className="lg:w-[30rem] lg:h-[20rem] ">
          ...
          <h2 className="font-medium lg:w-3/5 w-full text-center text-xl">Our objective is to ensure that our service is accessible and affordable for all those who require it.</h2>
        </div>
        </div>
      </div>
    </div>
